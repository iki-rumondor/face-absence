...
func StartServer(handlers *registry.Handlers) *gin.Engine {
	...
	teacher := router.Group("api").Use(middleware.IsValidJWT(), middleware.IsRole("GURU"))
	{
		...
		teacher.GET("schedules/:uuid", handlers.ScheduleHandler.GetScheduleByUuid)
	...
	admin := router.Group("api").Use(middleware.IsValidJWT(), middleware.IsRole("ADMIN"))
	{
		...
		admin.GET("school_fees/school-years/:schoolYearUuid", handlers.SchoolFeeHandler.GetBySchoolYear)
		admin.GET("school_fees/students/:studentUuid/latest", handlers.SchoolFeeHandler.GetNewStudentSchoolFee)
		...
		admin.GET("school_fees/fixed", handlers.SchoolFeeHandler.GetSchoolFeeNominal)
		admin.PUT("school_fees/fixed", handlers.SchoolFeeHandler.UpdateSchoolFeeNominal)
